...
class _$ContactMessageImpl implements _ContactMessage {
  ...
  @override
  String toString() {
    return 'ContactMessage(name: $name, email: $email, subject: $subject, message: $message, sentAt: $sentAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, name, email, subject, message, sentAt);
...
abstract class _ContactMessage implements ContactMessage {
  const factory _ContactMessage(
      ...
      final DateTime? sentAt}) = _$ContactMessageImpl;
