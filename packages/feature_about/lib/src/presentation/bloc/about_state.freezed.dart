...
/// @nodoc
mixin _$AboutState {
  AboutStatus get status => throw _privateConstructorUsedError;
...
abstract class $AboutStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AboutStatus status, Profile? profile, String? errorMessage});
}
...
class _$AboutStateImpl implements _AboutState {
  const _$AboutStateImpl(
      {this.status = AboutStatus.initial, this.profile, this.errorMessage});
  ...
  @override
  String toString() {
    return 'AboutState(status: $status, profile: $profile, errorMessage: $errorMessage)';
  }
...
abstract class _AboutState implements AboutState {
  const factory _AboutState(
      {final AboutStatus status,
      final Profile? profile,
      final String? errorMessage}) = _$AboutStateImpl;

  @override
  AboutStatus get status;
  @override
  Profile? get profile;
  @override
