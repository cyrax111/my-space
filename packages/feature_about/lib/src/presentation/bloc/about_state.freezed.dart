...
class _$AboutLoadedImpl implements AboutLoaded {
  const _$AboutLoadedImpl({required this.profile});
  ...
  @override
  String toString() {
    return 'AboutState.loaded(profile: $profile)';
  }
...
abstract class AboutLoaded implements AboutState {
  const factory AboutLoaded({required final Profile profile}) =
      _$AboutLoadedImpl;
...
class _$AboutErrorImpl implements AboutError {
  const _$AboutErrorImpl({required this.message});
...
abstract class AboutError implements AboutState {
  const factory AboutError({required final String message}) = _$AboutErrorImpl;
