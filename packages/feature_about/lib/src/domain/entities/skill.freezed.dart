...
class _$SkillImpl implements _Skill {
  ...
  @override
  String toString() {
    return 'Skill(name: $name, category: $category, proficiency: $proficiency, iconUrl: $iconUrl)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, name, category, proficiency, iconUrl);
...
abstract class _Skill implements Skill {
  const factory _Skill(
      ...
      final String? iconUrl}) = _$SkillImpl;
